...
const en = {
  ...
  radioWriteUnavailableDescription:
    "Radio Write was disabled for this build. You can still inspect and edit the Working Codeplug.",
  ...
  radioWriteSubjectMemoryChannelOrder: "Memory channel order",
  radioWriteSubjectFunctionSettings: "Function settings",
  radioWriteSubjectImportedCpsFile: "Imported CPS File",
  radioWriteSubjectSavedCodeplug: "Saved Codeplug",
  radioWriteSubjectDisplaySettings: "Display settings",
  radioWriteSubjectSoundSettings: "Sound settings",
  radioWriteSubjectKeyboardSettings: "Keyboard settings",
  radioWriteSubjectMenuVisibility: "Menu visibility",
  radioWriteSubjectAprsSettings: "APRS settings",
  radioWriteSubjectGpsSettings: "GPS settings",
  radioWriteSubjectBluetoothSettings: "Bluetooth settings",
  radioWriteSubjectSpectrumSettings: "Spectrum settings",
  radioWriteSubjectDtmfSettings: "DTMF settings",
  radioWriteSubjectTwoToneSettings: "2-Tone settings",
  radioWriteSubjectFiveToneSettings: "5-Tone settings",
  radioWriteSubjectFmBroadcastSettings: "FM Radio settings",
  radioWriteSubjectWriteImagePreparation: "Write image preparation",
  radioWriteSubjectVfoScanEdge: "VFO scan edge {number, number}",
  radioWriteSubjectFmChannel: "FM preset {number, number}",
  radioWriteSubjectBandZones: "Band {band} Zone selection",
  radioWriteSubjectBandScanLists: "Band {band} Scan List selection",
  radioWriteSubjectBandScanEdges: "Band {band} VFO scan edges",
  radioWriteFieldChannel: "Channel",
  radioWriteFieldWorkingCodeplug: "Working Codeplug",
  radioWriteFieldOtherCodeplugData: "Other Codeplug data",
  radioWriteFieldMirrorVfoChannels: "Mirror VFO temporary channels",
  radioWriteFieldRestoreWeatherChannels: "Restore fixed Weather channels",
  radioWriteValueWorkingCodeplug: "Working Codeplug",
  radioWriteValueBaselineBackup: "Baseline Backup",
  radioWriteValueFreshRadioRead: "Fresh Radio Read",
  radioWriteValueChangedBytes:
    "{count, plural, one {# changed byte} other {# changed bytes}}",
  radioWriteValueAppliedToWriteImage: "Applied to write image",
  ...
  cancel: "Cancel",
  metadataDescription:
    "A growing collection of local-first browser tools, starting with Radio CPS.",
  ...
  signalPreviewAction: "Preview",
  signalPreviewListen: "Listen",
  signalPreviewStop: "Stop",
  signalPreviewErrorTitle: "Tone Preview unavailable",
  signalPreviewUnsupported:
    "This browser does not provide the audio feature required for Tone Preview.",
  signalPreviewPlaybackError:
    "The browser could not start audio playback. Check this tab's sound permission and output device.",
  ...
  backupsCardTitle: "Saved Codeplugs",
  backupsDate: "Date",
  backupsSource: "Source",
  backupsRadio: "Radio",
  backupsFirmware: "Firmware",
  backupsChanges: "Changes",
  backupsActions: "Backup actions",
  backupsRadioRead: "Radio Read",
  ...
  backupsEmptyDescription:
    "A successful Radio Read or completed Radio Write will appear here automatically.",
  backupsDeleteTitle: "Delete this backup?",
  backupsDeleteDescription:
    "This removes the saved Codeplug from this browser. The action cannot be undone.",
  backupsDeleteAllTitle: "Delete all backups?",
  backupsDeleteAllDescription:
    "This permanently removes all {count, plural, one {# saved Codeplug} other {# saved Codeplugs}} from this browser.",
  ...
  cpsFileRestoreFailedTitle: "Restore preparation stopped",
  ...
  cpsFileAlreadyCurrentTitle: "Radio already matches the saved Codeplug",
  ...
  diagnosticsTitle: "Diagnostics & Support",
  diagnosticsReadinessTitle: "Environment readiness",
  diagnosticsReadinessDescription:
    "Browser capabilities used by local Radio operations and report storage.",
  diagnosticsSecureContext: "Secure context",
  diagnosticsOnline: "Network connection",
  diagnosticsWebSerial: "Web Serial",
  diagnosticsIndexedDb: "Local report storage",
  diagnosticsServiceWorker: "Offline app worker",
  diagnosticsPersistentStorage: "Persistent storage",
  diagnosticsAvailable: "Available",
  diagnosticsUnavailable: "Unavailable",
  diagnosticsActive: "Active",
  diagnosticsInactive: "Inactive",
  diagnosticsGranted: "Granted",
  diagnosticsBestEffort: "Best effort",
  diagnosticsSuccessTitle: "Last successful operations",
  diagnosticsSuccessDescription:
    "Only the latest successful Radio and Update summaries are retained.",
  diagnosticsNoSuccess: "No successful operation has been recorded yet.",
  diagnosticsIncidentsTitle: "Recent incidents",
  diagnosticsIncidentsDescription:
    "Up to 10 incidents per source are kept for 30 days in this browser.",
  diagnosticsEmptyTitle: "No diagnostic incidents",
  diagnosticsEmptyHint:
    "Failed or uncertain Radio and Update operations will appear here automatically.",
  diagnosticsDate: "Date",
  diagnosticsSource: "Source",
  diagnosticsOperation: "Operation",
  diagnosticsOperationRadioRead: "Radio Read",
  diagnosticsOperationRadioWrite: "Radio Write",
  diagnosticsOperationRestorePreparation: "Restore preparation",
  diagnosticsOperationFirmwareUpdate: "Firmware update",
  diagnosticsOperationLanguageUpdate: "Language Resource update",
  diagnosticsOperationImageUpdate: "Image Resource update",
  diagnosticsOperationCombinedUpdate: "Combined Resource update",
  diagnosticsOperationUpdate: "Radio update",
  diagnosticsOutcome: "Outcome",
  diagnosticsError: "Error code",
  diagnosticsActions: "Actions",
  diagnosticsRadio: "Radio",
  diagnosticsUpdate: "Update",
  diagnosticsSuccess: "Success",
  diagnosticsFailed: "Failed",
  diagnosticsOutcomeUnknown: "Outcome unknown",
  diagnosticsPreview: "Preview",
  diagnosticsDelete: "Delete",
  diagnosticsDeleteAll: "Clear all",
  diagnosticsDeleteTitle: "Delete this diagnostic report?",
  diagnosticsDeleteDescription:
    "This removes the local report from this browser. The action cannot be undone.",
  diagnosticsDeleteAllTitle: "Clear all diagnostic history?",
  diagnosticsDeleteAllDescription:
    "This removes every incident and successful-operation summary stored by Diagnostics in this browser.",
  diagnosticsStorageErrorTitle: "Diagnostic history could not be opened",
  diagnosticsStorageErrorDescription:
    "Check that browser storage is available, then reload this page.",
  diagnosticsPreviewDescription:
    "Review the exact sanitized JSON before copying, downloading, or emailing support.",
  diagnosticsGuidanceTitle: "What to do next",
  diagnosticsGuidanceUnknown:
    "Do not repeat an uncertain write or update. Keep the Radio powered and connected, then follow the recovery guidance for that operation.",
  diagnosticsGuidanceConnection:
    "Check Radio power and USB, reconnect directly without a hub, then retry only if the outcome is not marked unknown.",
  diagnosticsGuidanceDefault:
    "Download this report and attach it to a support email. Add what you were doing and what you saw on the Radio.",
  diagnosticsIncluded: "Included",
  diagnosticsIncludedDescription:
    "Operation phase, error code, safe protocol event summaries, browser capabilities, and public Radio versions when known.",
  diagnosticsExcluded: "Never included",
  diagnosticsExcludedDescription:
    "Serial number, CPU ID, raw frames, Codeplug bytes, update package bytes, arbitrary error text, full URLs, or user-agent data.",
  diagnosticsEvents: "{count, plural, one {# event} other {# events}}",
  diagnosticsCopy: "Copy JSON",
  diagnosticsCopied: "Copied",
  diagnosticsDownload: "Download JSON",
  diagnosticsEmail: "Email support",
  diagnosticsEmailHint:
    "Your email app opens with a safe summary. Attach the downloaded JSON report manually.",
  navAbout: "About",
  ...
  writeRadioPlanned: "Write Radio is unavailable",
  noRadio: "No Radio",
  ...
  footerRadioLabel: "Radio",
  footerCodeplugLabel: "Working Codeplug",
  footerChangesLabel: "Changes",
