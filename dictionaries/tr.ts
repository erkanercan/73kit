...
const tr = {
  ...
  vfoScanEdgeTitle: "VFO Tarama Sınırı {number, number}",
  vfoScanEdgeName: "Ad",
  ...
  vfoScanEdgeStepModeInvalid:
    "8,33 kHz adımı yalnızca AM modlarında kullanılabilir.",
  saveScanEdge: "Tarama Sınırını Kaydet",
  aprsTitle: "APRS",
